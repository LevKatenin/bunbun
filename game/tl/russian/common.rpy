...
translate russian strings:
    ...
    new "Вы уверены, что хотите сохранить поверх существующего сохранения?"

    # renpy/common/00gui.rpy:451
    old "Loading will lose unsaved progress.\nAre you sure you want to do this?"
    new "Загрузка может привести к потере прогресса. \nВы уверены, что хотите продолжить?"
    ...
    new "Вы уверены, что хотите вернуться в главное меню?\nЭто может привести к потере несохранённого прогресса."
