...
translate russian strings:
    ...
    old "Made with love (and {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].)"
    new "Сделано с любовью (и с помощью {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].)"
    ...
    new "Долгота ожидания до промотки"
